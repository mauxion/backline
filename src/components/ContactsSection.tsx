        ...
        <Card className="dark:bg-gray-900/60 backdrop-blur-sm shadow border-gray-600">
          ...
          <div className="mt-3 space-y-2 text-sm text-gray-200">
            <div className="flex justify-between gap-2">
              ...
              <a className="hover:underline" href="tel:+380000000000">+38 (063) 683-37-58</a>
            </div>
            <div className="flex justify-between gap-2">
              <span className="text-gray-400">Telegram</span>
              <a className="hover:underline" href="https://t.me/@backline_com_ua" target="_blank" rel="noreferrer">
                @backline_com_ua
              </a>
            </div>
            <div className="flex justify-between gap-2">
              <span className="text-gray-400">Email</span>
              <a className="hover:underline" href="mailto:mail@backline.com.ua">mail@backline.com.ua</a>
            </div>
            <div className="flex justify-between gap-2">
